...
This shows the output *format* only, with a fully passing run. It is not the
actual output of the `answers.md` in this sample folder, since that file's
answers are placeholder text for formatting purposes — paste your own real
`check.sh` output here when you submit.
