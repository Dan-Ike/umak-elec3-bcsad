...
1. Open the IAM service. In the left navigation pane, choose **Users**, then click your own user name (e.g., `bcsad-g01`). Choose the Permissions tab, then Add permissions, then Attach policies directly.
